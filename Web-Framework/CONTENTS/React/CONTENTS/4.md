> 在移动端或者PC端我们来模拟画板的实现， 支持清除和导出功能，此处简单实现，仅作开发参考。

### 效果演示

<div align=left>
  <img width="300" src="https://github.com/open-canvas-ui/canvas2dDraw/raw/master/screenshot/movie.gif"/>
</div>
...
- https://github.com/open-canvas-ui/canvas2dDraw